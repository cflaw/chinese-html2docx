...
for filename in sorted_alphanumeric(os.listdir(directory)):
    if filename.endswith('.html'):
        ...
        if(firstPagebreak):
            ...
            pagebreak.add_break(WD_BREAK.PAGE) # if next file exists, then add pagebreak
        ...
        ####### if extracting from local html
        document.add_paragraph(filename,  style='New Heading').paragraph_format.space_before = Pt(0)
